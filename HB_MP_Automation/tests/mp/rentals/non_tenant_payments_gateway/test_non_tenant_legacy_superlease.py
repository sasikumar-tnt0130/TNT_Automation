...
# Legacy Flow-Superlease Signing (individual + RAB) on Non-Tenant Payments.
...
@allure.story("Legacy Flow: Super Lease Signing - Individual (Non-Tenant Payments Gateway)")
class TestNonTenantSuperleaseIndividual:
