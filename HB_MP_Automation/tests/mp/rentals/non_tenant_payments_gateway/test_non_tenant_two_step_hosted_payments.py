"""Hosted card formats — Non-Tenant Payments / Two-Step.
...
@allure.story("Hosted card payments — Non-Tenant Payments / Two-Step")
@allure.link(
...
class TestNonTenantTwoStepHostedPayments:
    @allure.title("2Step-Non-Tenant Payments-16-digit card-rental confirmation")
    @pytest.mark.card
    ...
    @allure.title("2Step-Non-Tenant Payments-19-digit card-rental confirmation")
    @pytest.mark.card
    @pytest.mark.no_autopay
    @pytest.mark.desktop
    @pytest.mark.individual
    ...
    @allure.title("2Step-Non-Tenant Payments-Expiry MMYY-rental confirmation")
    @pytest.mark.card
    @pytest.mark.no_autopay
    @pytest.mark.desktop
    @pytest.mark.individual
    ...
    @allure.title("2Step-Non-Tenant Payments-Expiry MMYYYY-rental confirmation")
    @pytest.mark.card
    @pytest.mark.no_autopay
    @pytest.mark.desktop
    @pytest.mark.individual
    ...
    @allure.title("2Step-Non-Tenant Payments-CVV 3 digits-rental confirmation")
    @pytest.mark.card
    @pytest.mark.no_autopay
    @pytest.mark.desktop
    @pytest.mark.individual
    ...
    @allure.title("2Step-Non-Tenant Payments-CVV 4 digits (Amex)-rental confirmation")
    @pytest.mark.card
    @pytest.mark.no_autopay
    @pytest.mark.desktop
    @pytest.mark.individual
