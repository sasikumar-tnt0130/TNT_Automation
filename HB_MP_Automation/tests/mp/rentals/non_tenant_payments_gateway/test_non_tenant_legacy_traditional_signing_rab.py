...
# User's rental scenarios (2026-09-15): "Legacy Flow-Traditional Signing" as a
# business (RAB) - the individual cases are in
# test_non_tenant_legacy_traditional_signing_individual.py - on the non-
# Tenant-Payments gateway: cards go through Authorize.Net, set on both rental
...
@allure.story("Legacy Flow: Traditional Signing - RAB (Non-Tenant Payments Gateway)")
...
class TestNonTenantTraditionalSigningRab:
