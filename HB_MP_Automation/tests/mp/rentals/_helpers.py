...
from common_utils.browser_sessions import browser_permissions, hb_admin_context
...
@contextmanager
def legacy_signing_setup(browser, environment_config, app_config):
    """One HB admin context for Legacy property signing switches.

    Yields `LeaseConfigurationSetup`. No storefront context — storefront
    verify on signing helpers is unused; keep one Chromium context only.
    """
