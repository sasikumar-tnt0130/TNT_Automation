...
# 2Step Flow-Superlease Signing (individual + RAB) on Tenant Payments.
...
class TestTwoStepSuperleaseIndividual:
    ...
    def test_2step_flow_superlease_signing_ach_desktop_view_individual(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=False, view="desktop", rab=False, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_with_autopay_desktop_view_individual(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=True, view="desktop", rab=False, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_mobile_view_individual(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=False, view="mobile", rab=False, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_with_autopay_mobile_view_individual(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=True, view="mobile", rab=False, reserve=False), two_step=True
        )
@allure.feature("MP Rentals")
...
class TestTwoStepSuperleaseRab:
    ...
    def test_2step_flow_superlease_signing_ach_desktop_view_rab(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=False, view="desktop", rab=True, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_with_autopay_desktop_view_rab(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=True, view="desktop", rab=True, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_mobile_view_rab(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=False, view="mobile", rab=True, reserve=False), two_step=True
        )
    ...
    def test_2step_flow_superlease_signing_ach_with_autopay_mobile_view_rab(
        ...
        rental_case_runner(
            RentalCase(payment="ach", autopay=True, view="mobile", rab=True, reserve=False), two_step=True
        )
